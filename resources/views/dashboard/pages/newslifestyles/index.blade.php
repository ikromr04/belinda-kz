...
@section('content')
  <main class="page__content">
    ...
    <ul class="page__breadcrumbs">
      ...
      <li class="page__breadcrumb page__breadcrumb--current">| Новости и образ жизни</li>
    </ul>

    <div class="page__link-wrapper" style="padding: 0 2px">
      <h1 class="page__title">Новости и образ жизни</h1>
        ...
        <tbody>
          @foreach ($data['newslifestyles'] as $key => $newslifestyle)
            <tr>
              <td>{{ $key + 1 }}</td>
              <td>
                <div style="min-width: max-content;">{{ $newslifestyle->title }}</div>
              </td>
              <td>
                <div style="min-width: max-content;">{{ $newslifestyle->img ?? '' }}</div>
              </td>
              <td>
